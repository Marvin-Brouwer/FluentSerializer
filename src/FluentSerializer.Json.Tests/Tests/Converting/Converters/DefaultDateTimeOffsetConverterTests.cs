...
public sealed class DefaultDateTimeOffsetConverterTests
{
	...
	public static IEnumerable<object[]> GenerateConvertibleData()
	{
		...
		yield return new object[] { false, "\"4/20/2096 +0\"", new CultureInfo("en-US", useUserOverride: false) };
		yield return new object[] { true, "\"4/20/2096 4:20 AM +0\"", new CultureInfo("en-US", useUserOverride: false) };
		yield return new object[] { true, "\"20-04-2096 04:20 +0\"", new CultureInfo("nl-NL", useUserOverride: false) };
	}
