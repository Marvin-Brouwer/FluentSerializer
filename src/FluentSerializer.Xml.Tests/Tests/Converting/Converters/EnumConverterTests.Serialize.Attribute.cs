...
public sealed partial class EnumConverterTests
{
	...
	public void Serialize_Attribute_FormatUseEnumMember_Returns()
	{
		// Arrange
		var sut = new EnumConverter(EnumFormats.UseEnumMember);

		// Act
		var result1 = () => sut.ForAttribute().Serialize(TestValue.MemberWithDescription, _contextMock.Object);
		var result2 = () => sut.ForAttribute().Serialize(TestValue.MemberWithoutDescriptionOrEnumMember, _contextMock.Object);
		var result3 = sut.ForAttribute().Serialize(TestValue.MemberWithEnumMember, _contextMock.Object);
		var result4 = sut.ForAttribute().Serialize(TestValue.MemberWithEnumMemberAndDescription, _contextMock.Object);
	...
	[Fact,
		Trait("Category", "UnitTest"), Trait("DataFormat", "XML")]
	public void Serialize_Attribute_FormatUseDescription_Returns()
	{
		// Arrange
	...
	[Fact,
		Trait("Category", "UnitTest"), Trait("DataFormat", "XML")]
	public void Serialize_Attribute_FormatUseName_Returns()
	{
		// Arrange
		...
		var result1 = sut.ForAttribute().Serialize(TestValue.MemberWithDescription, _contextMock.Object);
		var result2 = sut.ForAttribute().Serialize(TestValue.MemberWithoutDescriptionOrEnumMember, _contextMock.Object);
		var result3 = sut.ForAttribute().Serialize(TestValue.MemberWithEnumMemberAndDescription, _contextMock.Object);
	...
	[Fact,
		Trait("Category", "UnitTest"), Trait("DataFormat", "XML")]
	public void Serialize_Attribute_FormatUseNumberValue_Returns()
	{
		// Arrange
		...
		var result1 = sut.ForAttribute().Serialize(TestValue.MemberWithDescription, _contextMock.Object);
		var result2 = sut.ForAttribute().Serialize(TestValue.MemberWithoutDescriptionOrEnumMember, _contextMock.Object);
		var result3 = sut.ForAttribute().Serialize(TestValue.MemberWithExplicitValue, _contextMock.Object);
		var result4 = sut.ForAttribute().Serialize(TestValue.MemberWithEnumMemberAndDescription, _contextMock.Object);
	...
	[Fact,
		Trait("Category", "UnitTest"), Trait("DataFormat", "XML")]
	public void Serialize_Attribute_FormatUseEnumMemberOrUseName_Returns()
	{
		// Arrange
	...
	[Fact,
		Trait("Category", "UnitTest"), Trait("DataFormat", "XML")]
	public void Serialize_Attribute_FormatUseDescriptionOrUseName_Returns()
	{
		// Arrange
	...
	[Fact,
		Trait("Category", "UnitTest"), Trait("DataFormat", "XML")]
	public void Serialize_Attribute_FormatUseEnumMemberOrUseNumberValue_Returns()
	{
		// Arrange
		...
		var result2 = sut.ForAttribute().Serialize(TestValue.MemberWithoutDescriptionOrEnumMember, _contextMock.Object);
		var result3 = sut.ForAttribute().Serialize(TestValue.MemberWithExplicitValue, _contextMock.Object);
		var result4 = sut.ForAttribute().Serialize(TestValue.MemberWithEnumMember, _contextMock.Object);
		var result5 = sut.ForAttribute().Serialize(TestValue.MemberWithEnumMemberAndDescription, _contextMock.Object);
	...
	[Fact,
		Trait("Category", "UnitTest"), Trait("DataFormat", "XML")]
	public void Serialize_Attribute_FormatUseDescriptionOrUseNumberValue_Returns()
	{
		// Arrange
