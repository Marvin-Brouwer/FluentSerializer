...
[assembly: SuppressMessage("Naming", "CA1716:Identifiers should not match keywords",
	Justification = "This refers to an Enum", Scope = "member", Target = "~M:FluentSerializer.Json.Converting.IUseJsonConverters.Enum(FluentSerializer.Core.Converting.Converters.EnumFormat,System.Boolean)~System.Func{FluentSerializer.Json.Converting.IJsonConverter}")]
[assembly: SuppressMessage("Naming", "CA1716:Identifiers should not match keywords",
	Justification = "This refers to an Enum", Scope = "member", Target = "~M:FluentSerializer.Json.Converting.UseJsonConverters.Enum(FluentSerializer.Core.Converting.Converters.EnumFormat,System.Boolean)~System.Func{FluentSerializer.Json.Converting.IJsonConverter}")]
