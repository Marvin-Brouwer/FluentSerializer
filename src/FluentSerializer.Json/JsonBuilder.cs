...
public readonly struct JsonBuilder
{
	...
	/// <param name="properties">A parameters list of <see cref="IJsonArrayContent"/> as children of this array node.</param>
	public static IJsonArray Array(params IJsonArrayContent[] elements) => new JsonArray(elements);
	/// <inheritdoc cref="IJsonArray"/>
	/// <param name="properties">A collection of <see cref="IJsonArrayContent"/> as children of this array node.</param>
